package com.system.travelmanagement;
...
public class ContactRepositoryTest {
    ...
    public void updateContactTest(){
        ...
        Assertions.assertThat(contactUpdated.getEmail()).isEqualTo("k@khatrig.com");
...
//        @Query(value = "SELECT * from")
        ...
        Optional<Contact> optionalContact = contactRepo.findContactByEmail("kriti@g.com");
